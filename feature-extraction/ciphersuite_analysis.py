...
def plotFreqByComponentType(data, title):
    # Base plot
    fig = plt.gcf()
    ...
    # Plot data
    plt.plot(data)
    plt.savefig(os.path.join(args.savedir,'ciphersuite-freq-by-componenttype({}).png'.format(title)))
    # plt.show()
...
if __name__ == '__main__':
    ...
    plotFreqByComponentType(averaged_parsedTraffic, dataset_name)
